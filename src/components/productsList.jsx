    ...
    return (
        <div className='mt-12 grid gap-y-8'>
            {products.map((product) => {
                ...
                return (
                    <Link to={`/products/${product.id}`} key={product.id} className="p-8 rounded-lg flex flex-row gap-4 flex-wrap bg-base-100 shadow-lg hover:shadow-2xl duration-300 group items-center">
